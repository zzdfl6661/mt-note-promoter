...
> 本文件由 `process.yaml` 自动渲染。截图链接指向本地 `logs/`（不随仓库分发），GitHub 上仅显示文字标记。
...
|---|---|---|---|---|---|---|
| S01 | goto | 机器 | 3252ms | `src/browser.py::goto` | 已验证 | 截图 |
| S02 | login_check | 机器/可转人工 | 3695ms | `src/flow.py::_ensure_login` | 已验证 | 截图 |
| S03 | direct_nav_budget | 机器 | 2388ms | `src/flow.py::_nav_direct` | 已验证 | 截图 |
| S04 | after_submit | 机器 | 3104ms | `src/flow.py::_do_post_store_steps` | 已验证 | 截图 |
| S05 | after_submit_confirm | 机器 | 2421ms | `src/flow.py::_do_post_store_steps` | 已验证 | 截图 |
| S06 | after_human | 机器/可转人工 | - | `src/browser.py::pause_for_human` | 未验证 | - |
| S07 | after_save_draft | 机器 | - | `src/flow.py::_do_post_store_steps` | 未验证 | - |
| S08 | 悬停预算名称 | 机器 | 1816ms | - | 已验证 | 截图 |
| S09 | 悬停新增推广 | 机器 | 1810ms | - | 已验证 | 截图 |
| S10 | 去新建推广 | 机器 | 1788ms | - | 已验证 | 截图 |
| S11 | 内容种草 | 机器 | 2368ms | - | 已验证 | 截图 |
| S12 | 打开门店下拉 | 机器 | 163ms | - | 已验证 | 截图 |
| S13 | 搜索门店 | 机器 | 6319ms | - | 已验证 | 截图 |
| S14 | 等待笔记卡片 | 机器 | 382ms | - | 已验证 | 截图 |
| S15 | 打开笔记选择抽屉 | 机器 | 294ms | - | 已验证 | 截图 |
| S16 | wait | 机器 | 1731ms | - | 已验证 | 截图 |
| S17 | 确认修改笔记 | 机器 | 6421ms | - | 已验证 | 截图 |
| S18 | 推广地域-修改 | 机器 | 2140ms | - | 已验证 | 截图 |
| S19 | 等待地域抽屉 | 机器 | 203ms | - | 已验证 | 截图 |
| S20 | 选择门店附近区域 | 机器 | 1150ms | - | 已验证 | 截图 |
| S21 | 地域-距离km | 机器 | 3435ms | - | 已验证 | 截图 |
| S22 | 出价-单次点击 | 机器 | 1252ms | - | 已验证 | 截图 |
| S23 | 下一步 | 机器 | 4836ms | - | 已验证 | 截图 |
| S24 | 保存并提交 | 机器 | 5116ms | - | 已验证 | 截图 |
| S25 | 选择门店 | 机器 | 4964ms | - | 已验证 | 截图 |
